  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          className="absolute inset-0 bg-gradient-to-tr from-primary/5 via-transparent to-primary/10 animate-pulse"
        ...
        />
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gold/15 rounded-full blur-3xl animate-pulse"
