		  ...
		  <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
			<div className="max-w-4xl mx-auto text-center space-y-6">
			  ...
			  <p
				...
				"
			  >
				Sping.tech provides a full casino platform with bonus, jackpot
				and tournament engines, flexible front-end and risk tooling —
				designed for fast launches and high LTV players.
			  </p>
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
			  <div className="max-w-3xl mb-10 space-y-3">
				...
				<p className="text-sm sm:text-base text-muted-foreground max-w-2xl">
				  Our bonus, jackpot and tournament engines are built for growth
				  teams: fast to configure, deeply configurable, and safe from
				  abuse.
				</p>
			  </div>
				...
				<div className="grid gap-10 lg:grid-cols-2 items-center px-4 sm:px-6 lg:px-8 py-10 sm:py-12 lg:py-14">
				  <div className="space-y-5">
					...
					<p className="text-sm sm:text-base text-muted-foreground">
					  We provide a fully configurable casino lobby built on a
					  widget system with dozens of layout options. You can
					  launch country-specific lobbies, test line-ups, and adapt
					  the experience to any segment without involving engineers.
					</p>
					...
					<div className="grid gap-4 sm:grid-cols-2 text-sm text-muted-foreground">
					  <div className="space-y-1.5">
						...
						<p>
						  Home, category carousels, providers, jackpots,
